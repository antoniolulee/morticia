class OperationsController < ApplicationController
  ...
  private
    ...
    def operation_params
      params.require(:operation).permit(:requested_money, :buying_price, :appraisal_price, :years_duration, :year_of_birth, :annual_gross_income, :city, :name, :interest_type, :email)
    end
end
